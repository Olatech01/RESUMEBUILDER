...
import { ProfileInfoCard } from '@/Reusable/Cards'
                    ...
                    <div className='hidden md:flex items-center'>
                        {user ? (
                            ...
                            >
                                ...
                                <div className={landingPageStyles.desktopAuthButtonText}>Get Started</div>
                            </button>
                        )}
                    </div>
                </div>
                    ...
                    <div className={landingPageStyles.featuresContainer}>
                        <div className={landingPageStyles.featuresHeader}>
                            ...
                            <p className={landingPageStyles.featuresDescription}>
                                Everything you must to create a professional resume that stands out
                            </p>
                        </div>
