...
export const TemplateCard = ({ thumbnailing, isSelected, onSelect }) => {
    return (
        <div className={`group h-auto md:h-[300px] flex flex-col bg-white border-2 overflow-hidden
        cursor-pointer transition-all duration-300 hover:scale-105 hover:shadow-lg rounded-3xl
        ...
        >
            {thumbnailing ? (
                <div className="relative w-full overflow-hidden">
                    <img
                        src={thumbnailing || "/placeholder.svg"}
                        alt="template review"
                    ...
                    <div className="absolute inset-0 bg-gradient-to-r from-violet-100/10 to-transparent opacity-0
                    group-hover:opacity-100 transition-opacity duration-300"></div>
                </div>
            ) : (
                <div className="w-full h-[200px] flex items-center justify-center bg-gradient-to-r from-violet-200 via-violet-600 to-fuchsia-50">
                    <div className="w-12 h-12 bg-gradient-to-r from-violet-500 to-fuchsia-500 rounded-2xl flex items-center justify-center mb-3">
