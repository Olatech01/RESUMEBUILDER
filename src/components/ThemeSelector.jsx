...
import { TemplateCard } from '@/Reusable/Cards';
...
const ThemeSelector = ({ selectedTheme, setSelectedTheme, resumeData, onClose }) => {
    ...
    return (
        ...
        p-4 sm:p-6 bg-gradient-to-r from-white to-violet-50 rounded-2xl border border-violet-100'>
            ...
            from-violet-600 to-fuchsia-600 text-white font-black rounded-2xl hover:scale-125 
                    ...
                    <div className='grid grid-cols-1 sm:grid-cols-2 gap-4 max-h-[60vh] lg:max-h-[70vh] overflow-auto p-2'>
                        {resumeTemplates.map((templates, index) => (
                            <TemplateCard
                                ...
                                thumbnailing={templates.thumbnailImg}
